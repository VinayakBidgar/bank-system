...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo "SMART BANK SYSTEM"; ?>
  </a>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to SMART BANK SYSTEM</h4>
  ...
  <?php 
      ...
      if ($array->num_rows > 0)
      {
        ...
        echo "<div class='alert alert-info'>Notice boS empty</div>";
     ?></p>
